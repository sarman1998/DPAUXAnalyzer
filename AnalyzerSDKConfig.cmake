...
set_target_properties(Saleae::AnalyzerSDK PROPERTIES INTERFACE_INCLUDE_DIRECTORIES ${CMAKE_CURRENT_LIST_DIR}/source)
...
if (APPLE)
    ...
    set_target_properties(Saleae::AnalyzerSDK PROPERTIES
                                              IMPORTED_LOCATION ${CMAKE_CURRENT_LIST_DIR}/${LIB_DIR}/libDisplayPortAUXAnalyzer.dylib)
elseif(WIN32)
    set_target_properties(Saleae::AnalyzerSDK PROPERTIES
                                              IMPORTED_LOCATION ${CMAKE_CURRENT_LIST_DIR}/lib_x86_64/DisplayPortAUXAnalyzer.dll
                                              IMPORTED_IMPLIB   ${CMAKE_CURRENT_LIST_DIR}/lib_x86_64/DisplayPortAUXAnalyzer.lib)
elseif(UNIX AND NOT APPLE)
    set_target_properties(Saleae::AnalyzerSDK PROPERTIES
                                              IMPORTED_LOCATION ${CMAKE_CURRENT_LIST_DIR}/lib_x86_64/libDisplayPortAUXAnalyzer.so
                                              IMPORTED_SONAME   libDisplayPortAUXAnalyzer.so)
endif()
